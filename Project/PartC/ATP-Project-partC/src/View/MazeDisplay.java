...
//                        graphicsContext2D.fillRect(i,j,cellHeight,cellWidth);
                ...
                //draw end point
                Image endPos = new Image(new FileInputStream("resources/images/unicorn.png"));
                ...
                if (isSolved) {
                    ...
                    Image SolutionImage = new Image(new FileInputStream("resources/images/Panther.png"));
                ...
                //draw start point
                Image StartPoint = new Image(new FileInputStream("resources/images/pouch.png"));
                graphicsContext2D.drawImage(StartPoint, 0, 0, cellHeight, cellWidth);
                //Draw Character
                Image characterImage = new Image(new FileInputStream("resources/images/noa.PNG"));
